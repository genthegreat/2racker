...
export default function ForgotPassword() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (result === "success") {
      ...
      setMessage(`${result ?? "Unable to send reset email"}. Try again later.`);
      setColor("red");
    }
  };
  ...
  return (
    <main
      id="content"
      role="main"
      className="w-full flex items-center justify-center max-w-md mx-auto min-h-full"
    >
      <div className="border-solid border-2 border-lime-900 rounded-lg py-2 max-w-md">
        <div className="p-1 sm:p-7">
          <div className="text-center">
            <h1 className="block text-2xl font-bold dark:text-gray-200">
              Forgot password?
            </h1>
        ...
        <p className="mt-3 flex justify-center items-center text-center divide-x divide-gray-300 dark:divide-gray-700">
          ...
          <a
            ...
            href="mailto:ezragonyuie@gmail.com, ezragonyuie@gmail.com?subject=problem on forgot password"
          >
            Contact us!
          </a>
        </p>
